...
function UpdateRecordInfo(props) {
  ...
  useEffect(() => {
    axios
      .get(`https://5000-santoshini18-hsptlmmt-0vwjdk3ufw5.ws-us93.gitpod.io/api/hsptlmmt/${id}`)
      .then((res) => {
        setHsptl({
          name: res.data.name,
          age: res.data.age,
  ...
  const onSubmit = (e) => {
    ...
    axios
      .put(`https://5000-santoshini18-hsptlmmt-0vwjdk3ufw5.ws-us93.gitpod.io/api/hsptlmmt/${id}`, data)
      .then((res) => {
