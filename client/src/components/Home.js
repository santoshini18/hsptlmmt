        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="service-grid card ">
              ...
              <div class="service-text">
                <h4>Outdoor Checkup</h4>
                <p>Health assessment conducted in natural outdoor environments, utilizing nature's benefits for physical and emotional well-being assessments.Most of the times, villagers have to travel to the nearest primary healthcare centre </p>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
